 ...
 * @author frans
 */
public class importUser extends javax.swing.JFrame {
    ...
    public importUser() {
        ...
        btn_startImport.setEnabled(false);
    }
    ...
    private void btn_importFileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_importFileMouseClicked
        ...
        if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                btn_startImport.setEnabled(true);
    ...
    private void btn_startImportMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_startImportMouseClicked
        ...
        try {
            ...
            lastRow=datatypeSheet.getPhysicalNumberOfRows();
            while (rowIterator.hasNext()) {
                ...
                while (cellIterator.hasNext()) {
                    ...
                    if (columnIndex == 0) {
                        ...
                        String userid = formatter.formatCellValue(isi_kolom_skrg);
                        mUser.setUser_id(Integer.parseInt(userid));
                    } else if (columnIndex == 1) {
                        Cell isi_kolom_skrg = datatypeSheet.getRow(nextCell.getRowIndex()).getCell(columnIndex);
                        String lokasi = formatter.formatCellValue(isi_kolom_skrg);
                        mUser.setUser_loc(lokasi);
                    } else if (columnIndex == 2) {
                        Cell isi_kolom_skrg = datatypeSheet.getRow(nextCell.getRowIndex()).getCell(columnIndex);
                        String userAge = formatter.formatCellValue(isi_kolom_skrg);
                        int user_age = 0;
                        if (userAge.equals("NULL") || userAge.equals("")) {
                            user_age = 0;
                        } else {
                            user_age = Integer.parseInt(userAge);
                        }
                        mUser.setUser_age(user_age);
                    }
                }
                total++;
                System.out.println("PROCESSING "+total+" OF "+lastRow+" DATAS");
                new C_User().tambah_User(mUser);
